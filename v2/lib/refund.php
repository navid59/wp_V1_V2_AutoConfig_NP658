...
class refund {
    ...
    function __construct(){
        ...
        /**
         * Set the request to refund
         * @output json
         */
        public function setRefundRequest() {
            $refundArr = array(
        ...
        // Send request json
        public function sendRefundRequest($jsonStr) {
            if(!isset($this->apiKey) || is_null($this->apiKey)) {
                throw new \Exception('INVALID_APIKEY');
                exit;
            }

            $url = $this->isLive ? 'https://secure.mobilpay.ro/pay/operation/credit' : 'https://secure.sandbox.netopia-payments.com/operation/credit';
            $ch = curl_init($url);
